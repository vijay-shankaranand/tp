...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_CONTACT_NOT_DISPLAYED =
        "Contact list not displayed. Unable to perform command.";
    public static final String MESSAGE_INVALID_EVENT_DISPLAYED_INDEX = "The event index provided is invalid";
    public static final String MESSAGE_INVALID_EVENT_NOT_DISPLAYED =
        "Event list not displayed. Unable to perform command.";
