...
1. Download the latest `jobfestgo.jar` from [here](https://github.com/se-edu/addressbook-level3/releases).
...
Examples:
* `delete_tag` followed by `tn/vendor` deletes the tag: vendor in JobFestGo.
